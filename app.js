...
----------------------------------------------------------- */
const QUESTION_POOL = [
  // --- Lote nuevo (25 preguntas, opciones en orden revuelto a propósito) ---
  { type: "text", q: "Cuando alguien se atribuye el mérito de tu trabajo...", options: [
    { text: "Aclaro con calma lo que aporté yo.", value: 2 },
    { text: "Lo dejo en evidencia y en ridículo.", value: 4 },
    { text: "No digo nada; no vale la pena pelear.", value: 0 },
    { text: "Le exijo que reconozca que fue mío.", value: 3 },
    { text: "Me molesta, pero lo dejo pasar callado.", value: 1 },
  ]},
  { type: "text", q: "Si alguien revisa tus cosas privadas sin permiso...", options: [
    { text: "Lo permito; no tengo nada que ocultar.", value: 0 },
    { text: "Le dejo muy claro que eso no se hace.", value: 3 },
    { text: "No digo nada y guardo mejor mis cosas.", value: 1 },
    { text: "Le revuelvo sus cosas para que vea qué se siente.", value: 4 },
    { text: "Le pido que respete mi privacidad.", value: 2 },
  ]},
  { type: "text", q: "Cuando tienes que hablar frente a mucha gente...", options: [
    { text: "Me incomoda tanto que termino de mal humor.", value: 4 },
    { text: "Busco la forma de que hable alguien más.", value: 1 },
    { text: "Me preparo y lo hago lo mejor que puedo.", value: 2 },
    { text: "Me pongo nervioso y siento que lo haré mal.", value: 0 },
    { text: "Tomo el control y dirijo la sala.", value: 3 },
  ]},
  { type: "text", q: "Si te atienden de mala gana en un negocio...", options: [
    { text: "No digo nada y mejor me voy.", value: 1 },
    { text: "Pido un buen trato con educación.", value: 2 },
    { text: "Exijo hablar con el encargado.", value: 3 },
    { text: "Aguanto; quizá tuvo un mal día.", value: 0 },
    { text: "Le contesto igual de mal o peor.", value: 4 },
  ]},
  { type: "text", q: "Cuando alguien daña algo tuyo y no lo reconoce...", options: [
    { text: "Le exijo que lo pague o lo reponga.", value: 3 },
    { text: "Lo dejo así; las cosas se reemplazan.", value: 0 },
    { text: "Le hago lo mismo con algo suyo.", value: 4 },
    { text: "Le pido que hablemos y lo resolvamos.", value: 2 },
    { text: "No reclamo, pero me alejo de esa persona.", value: 1 },
  ]},
  { type: "text", q: "Si en una reunión interrumpen siempre lo que dices...", options: [
    { text: "Pido con calma que me dejen terminar.", value: 2 },
    { text: "Me callo y ya no participo.", value: 1 },
    { text: "Levanto la voz para callar a quien interrumpe.", value: 4 },
    { text: "Pienso que lo mío no era importante.", value: 0 },
    { text: "Me impongo y sigo hablando sí o sí.", value: 3 },
  ]},
  { type: "text", q: "Cuando descubres que alguien te mintió...", options: [
    { text: "Lo expongo para que todos vean cómo es.", value: 4 },
    { text: "Le digo cómo me hizo sentir y por qué.", value: 2 },
    { text: "Lo justifico; seguro tenía sus razones.", value: 0 },
    { text: "Le exijo la verdad de inmediato.", value: 3 },
    { text: "No digo nada y tomo distancia.", value: 1 },
  ]},
  { type: "text", q: "Si te presionan para hacer algo en contra de tus valores...", options: [
    { text: "Termino cediendo para no quedar mal.", value: 0 },
    { text: "Me niego rotundamente y corto el tema.", value: 3 },
    { text: "Explico con firmeza por qué no lo haré.", value: 2 },
    { text: "Me molesto y respondo de mala forma.", value: 4 },
    { text: "Doy largas hasta que se olvide.", value: 1 },
  ]},
  { type: "text", q: "Cuando tu jefe o maestro te corrige delante de otros...", options: [
    { text: "Me quedo callado y no reacciono.", value: 1 },
    { text: "Siento mucha vergüenza y me disculpo.", value: 0 },
    { text: "Lo tomo como aprendizaje sin dramatizar.", value: 2 },
    { text: "Le respondo molesto delante de todos.", value: 4 },
    { text: "Defiendo mi postura sin ceder.", value: 3 },
  ]},
  { type: "text", q: "Si se burlan de tu forma de vestir o de hablar...", options: [
    { text: "Les dejo claro que a mí no me afecta.", value: 3 },
    { text: "Les digo con calma que no me gusta.", value: 2 },
    { text: "Me lo creo y trato de cambiar para encajar.", value: 0 },
    { text: "Hago como si no escuchara y me alejo.", value: 1 },
    { text: "Me burlo de algo suyo todavía peor.", value: 4 },
  ]},
  { type: "text", q: "Cuando hay que repartir tareas y nadie quiere las pesadas...", options: [
    { text: "Obligo a otros a hacerlas como sea.", value: 4 },
    { text: "Me quedo con las pesadas para no discutir.", value: 0 },
    { text: "Propongo repartirlas de forma justa.", value: 2 },
    { text: "Me hago a un lado y dejo que se acomode solo.", value: 1 },
    { text: "Asigno yo quién hace cada cosa.", value: 3 },
  ]},
  { type: "text", q: "Si una persona siempre llega tarde a tus citas...", options: [
    { text: "Le digo que valoro mi tiempo y el suyo.", value: 2 },
    { text: "No digo nada, pero ya no la espero.", value: 1 },
    { text: "Le pongo un ultimátum.", value: 3 },
    { text: "Lo acepto; mejor llego tarde yo también.", value: 0 },
    { text: "La dejo plantada para que aprenda.", value: 4 },
  ]},
  { type: "text", q: "Cuando sientes que te dejan fuera de un plan a propósito...", options: [
    { text: "Pienso que algo hice mal y me disculpo.", value: 0 },
    { text: "Pregunto directamente qué pasó.", value: 2 },
    { text: "Los excluyo a ellos la próxima vez.", value: 4 },
    { text: "Me alejo en silencio y no pregunto.", value: 1 },
    { text: "Les hago saber que a mí no me ignoran.", value: 3 },
  ]},
  { type: "text", q: "Si alguien usa tus cosas sin avisarte...", options: [
    { text: "Le prohíbo tocar mis cosas otra vez.", value: 3 },
    { text: "Tomo las suyas sin avisar, a ver si le gusta.", value: 4 },
    { text: "No digo nada, solo las escondo mejor.", value: 1 },
    { text: "Le pido que me avise la próxima vez.", value: 2 },
    { text: "Lo dejo pasar; son solo cosas.", value: 0 },
  ]},
  { type: "text", q: "Cuando te interrumpen una y otra vez al hablar...", options: [
    { text: "Me rindo y dejo de hablar.", value: 1 },
    { text: "Pido amablemente terminar mi idea.", value: 2 },
    { text: "Cedo el turno; lo suyo será más importante.", value: 0 },
    { text: "Subo el tono y sigo hasta acabar.", value: 3 },
    { text: "Los corto en seco de mala manera.", value: 4 },
  ]},
  { type: "text", q: "Si te enteras de que hablaron mal de ti a tus espaldas...", options: [
    { text: "Hago lo mismo y hablo peor de ellos.", value: 4 },
    { text: "Lo hablo de frente con esa persona.", value: 2 },
    { text: "Lo ignoro y me alejo de ese grupo.", value: 1 },
    { text: "Pienso que algo de razón tendrán.", value: 0 },
    { text: "Les reclamo y exijo una explicación.", value: 3 },
  ]},
  { type: "text", q: "Cuando alguien depende demasiado de ti y te agota...", options: [
    { text: "Sigo ayudando aunque me agote.", value: 0 },
    { text: "Le corto de tajo y que se arregle solo.", value: 3 },
    { text: "Le explico que necesito mi espacio.", value: 2 },
    { text: "Empiezo a desaparecer poco a poco.", value: 1 },
    { text: "Le reclamo que es una carga.", value: 4 },
  ]},
  { type: "text", q: "Si tomas una decisión y todos la cuestionan...", options: [
    { text: "Cambio de opinión para no incomodar.", value: 0 },
    { text: "Me quedo callado y no la defiendo.", value: 1 },
    { text: "Explico mis razones con calma.", value: 2 },
    { text: "Me molesto y descalifico sus dudas.", value: 4 },
    { text: "Mantengo mi decisión cueste lo que cueste.", value: 3 },
  ]},
  { type: "text", q: "Cuando un amigo te debe dinero y no lo menciona...", options: [
    { text: "No digo nada y lo doy por perdido.", value: 1 },
    { text: "Le recuerdo el tema con naturalidad.", value: 2 },
    { text: "Me da pena cobrarle y lo dejo así.", value: 0 },
    { text: "Lo expongo delante de otros.", value: 4 },
    { text: "Le exijo que me pague ya.", value: 3 },
  ]},
  { type: "text", q: "Si alguien hace trampa para ganarte...", options: [
    { text: "Le exijo que se repita el juego limpio.", value: 3 },
    { text: "Hago trampa todavía peor para ganarle.", value: 4 },
    { text: "Lo dejo ganar; no es para tanto.", value: 0 },
    { text: "Le señalo la trampa con calma.", value: 2 },
    { text: "No digo nada y ya no juego con esa persona.", value: 1 },
  ]},
  { type: "text", q: "Cuando un plan importante se arruina por otra persona...", options: [
    { text: "La culpo y se lo hago saber con dureza.", value: 4 },
    { text: "Busco cómo resolverlo entre los dos.", value: 2 },
    { text: "Me frustro pero no digo nada.", value: 1 },
    { text: "Asumo yo la culpa aunque no sea mía.", value: 0 },
    { text: "Tomo el control y arreglo todo a mi manera.", value: 3 },
  ]},
  { type: "text", q: "Si te insisten en algo después de que dijiste que no...", options: [
    { text: "Repito mi no con tranquilidad.", value: 2 },
    { text: "Termino aceptando para que dejen de insistir.", value: 0 },
    { text: "Me planto y no cedo ni un poco.", value: 3 },
    { text: "Cambio de tema para escapar.", value: 1 },
    { text: "Respondo cortante para que no insistan.", value: 4 },
  ]},
  { type: "text", q: "Cuando ves que tratan injustamente a un desconocido...", options: [
    { text: "Prefiero no meterme y sigo mi camino.", value: 1 },
    { text: "Intervengo con calma para ayudar.", value: 2 },
    { text: "Me da pena, pero pienso que no es mi asunto.", value: 0 },
    { text: "Me impongo y paro la situación.", value: 3 },
    { text: "Encaro con agresividad a quien lo trata mal.", value: 4 },
  ]},
  { type: "text", q: "Si alguien minimiza algo que para ti es importante...", options: [
    { text: "Pienso que quizá estoy exagerando.", value: 0 },
    { text: "Le explico por qué para mí sí importa.", value: 2 },
    { text: "Cambio de tema y me lo guardo.", value: 1 },
    { text: "Le resto importancia a lo suyo también.", value: 4 },
    { text: "Le dejo claro que respete lo que siento.", value: 3 },
  ]},
  { type: "text", q: "Cuando alguien te habla con un tono déspota...", options: [
    { text: "Le contesto con un tono todavía peor.", value: 4 },
    { text: "Le pido con calma que me hable bien.", value: 2 },
    { text: "Bajo la cabeza y obedezco.", value: 0 },
    { text: "No respondo y me retiro.", value: 1 },
    { text: "Le exijo respeto de inmediato.", value: 3 },
  ]},
  // --- Banco original ---
